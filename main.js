...
//#region writeProducts
function writeProductsFirstPage() {
   storedNames = products;
    if (storedNames != null) {
        var Text = "<div class=\"row\">";
        storedNames.forEach(element => {
            Text = Text + "<div class=\"col-xxl-1 product\" >" +
                "<img src=\"images/products/" + element.img + "\" alt=\"product img\">" +
                "<br><p>" + element.Name +
                "<br>Size: " + element.Size + "<br>Price: " + element.Price +
                "</p><button onclick=\"Buy('" + element.Name + "')\"> Buy</button></div>";
        });
        Text = Text + "</div>";
